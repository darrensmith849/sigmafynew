    ...
    <main className="min-h-screen bg-bg text-fg">
      ...
      <section className="mx-auto grid max-w-shell gap-12 px-5 py-16 sm:px-8 lg:grid-cols-2 lg:items-center">
        <div>
          ...
          <h1 className="h-display-lg mt-3 text-fg">Pick up where you left off.</h1>
          <p className="t-lede mt-4 max-w-md">
            Sign in to browse the 288-tool catalogue, run an analysis, or revisit a
            previous run from your workspace.
          </p>
        </div>
