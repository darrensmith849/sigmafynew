...
export interface IMRTopicContent {
  input: IMRRequest;
  result: IMRResponse;
}

export async function runImr(input: {
  projectId: string;
  phaseSlug: string;
  sectionSlug: string;
  topicSlug: string;
  request: IMRRequest;
}): Promise<{ ok: true; result: IMRResponse }> {
